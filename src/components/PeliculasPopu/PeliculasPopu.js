            ...
            <React.Fragment>
                ...
                <div className={`${this.state.orientacion === 'column' ? 
                    ...
                    { 
                        ...
                        this.state.peliculas.map((pelicula, index)=><CardPopu key={pelicula.original_title + index} dataPelicula={pelicula} borrar = {(idEliminar) => this.borrarTarjeta(idEliminar) } 
                        />) 
                    }  
                </div>
                {
